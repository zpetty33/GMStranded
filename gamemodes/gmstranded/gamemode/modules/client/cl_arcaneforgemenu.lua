function SGS_ArcaneForgeMenu()
	...
	SGS.arcaneforgemenu = vgui.Create( "DFrame" )
	SGS.arcaneforgemenu:ShowCloseButton(true)
	SGS.arcaneforgemenu:SetDraggable(false)
	SGS.arcaneforgemenu:SetSize( 320,340 )
	SGS.arcaneforgemenu:SetPos( ScrW() / 2 - 160, ScrH() / 2 - 170 )
	SGS.arcaneforgemenu:SetTitle( "Arcane Forging Menu" )

	local CatList = vgui.Create( "DPanelList", SGS.arcaneforgemenu)
