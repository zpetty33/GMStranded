	...
	local emitter = ParticleEmitter( self.Origin, false )
		...
		for i=0, NumParticles do
			...
			if ColorParticleStreak && GlowEffect then
				...
				ColorParticleStreak:SetColor( 255,255,0 )
				...
				timer.Simple(2, function() ColorParticleStreak:SetVelocity( Vector(math.Rand(-1.0, 1.0), math.Rand(-1.0, 1.0), 0):GetNormal() * 250 ) end)
