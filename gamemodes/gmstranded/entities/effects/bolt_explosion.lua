	...
	local emitter = ParticleEmitter( self.Origin, false )
		...
		for i=0, NumParticles do
			...
			if ColorParticleStreak && GlowEffect then
				...
				ColorParticleStreak:SetVelocity( Vector(math.Rand(-1.0, 1.0), math.Rand(-1.0, 1.0), math.Rand(-1.0, 1.0)):GetNormal() * math.Rand(250,400) )
				...
				local Gravity = math.Rand( 600, 800 )
