...
function SWEP:PrimaryAttack()
	...
	if self.Owner:GetLevel("fishing") < 65 then
		self.Owner:SendMessage("This tool requires fishing level 65 or higher.", 60, Color(255, 125, 0, 255))
		return
	end

	SGS_Fish_Start( self.Owner, 1.2, 3.8 )
end
