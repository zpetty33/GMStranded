...
SWEP.VElements = {
	["sifter_model"] = { type = "Model", model = "models/devonjones/stranded/sifter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.119, 6.32, -0.654), angle = Angle(120.391, 45.266, -3.23), size = Vector(0.795, 0.795, 0.795), color = Color(255 * 0.45, 255 * 0.3, 255 * 0.3, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["sifter_model"] = { type = "Model", model = "models/devonjones/stranded/sifter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.177, 6.592, -2.96), angle = Angle(102.133, 76.799, -62.304), size = Vector(0.795, 0.795, 0.795), color = Color(255 * 0.45, 255 * 0.3, 255 * 0.3, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
