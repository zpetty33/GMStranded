...
SWEP.VElements = {
	["hoe_model"] = { type = "Model", model = "models/devonjones/stranded/hoe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.15, 1.659, -6.296), angle = Angle(180, 61.928, 2.528), size = Vector(0.689, 0.689, 0.689), color = Color(76, 25, 25, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["hoe_model"] = { type = "Model", model = "models/devonjones/stranded/hoe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.69, 2.509, -6.687), angle = Angle(5.716, -115.833, -175.655), size = Vector(0.87, 0.87, 0.87), color = Color(76, 25, 25, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:GetLevel("farming") < 45 then
		self.Owner:SendMessage("This tool requires farming level 45 or higher.", 60, Color(255, 125, 0, 255))
		return
	end
