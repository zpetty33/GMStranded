...
function ENT:PhysicsSimulate( physobj, deltatime )
	...
	local pos = self.m_Player:GetPos() + Vector( TimedCos(1, 0, 2, 0) * self.range,	TimedSin(1, 0, 2, 0) * self.range, TimedSin(1.2, -5, 5, 0) + 80	)
	--print(math.floor(TimedCos(0.5, 0, 2, 0) * self.range))
