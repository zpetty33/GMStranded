...
function ENT:Initialize()
	self:SetModel(SGS.proplist["easteregg"])
...
function ENT:Use( ply )
	ply:SendMessage("You picked up an easter egg.",3,Color(255,50,50,255))
	ply:AddResource("easter_egg", 1)
	ServerLog( ply:Nick() .. " found an easter egg\n")
	SGS.Log( ply:Nick() .. " found an easter egg")
	self:Remove()
end
